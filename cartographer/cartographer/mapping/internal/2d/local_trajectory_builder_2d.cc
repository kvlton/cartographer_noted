...
LocalTrajectoryBuilder2D::TransformToGravityAlignedFrameAndFilter(
    const transform::Rigid3f& transform_to_gravity_aligned_frame, // odom to base
...
LocalTrajectoryBuilder2D::AddRangeData(
  ...
  // 2.预测每个point的pose (base_link在odom下的pose), 用于畸变校准
  ...
  // 3.校准后的点云转换成sensor::RangeData格式，并将miss和hit分类
